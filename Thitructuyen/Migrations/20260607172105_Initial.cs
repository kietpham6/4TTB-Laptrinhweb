        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Department = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarUrl = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EasyCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    MediumCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    HardCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViolationLog = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionA = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: ""),
                    OptionB = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: ""),
                    OptionC = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: ""),
                    OptionD = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: ""),
                    CorrectAnswer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Points = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    SubjectId = table.Column<int>(type: "int", nullable: true),
                    ChapterId = table.Column<int>(type: "int", nullable: true),
                    Difficulty = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Trung bình"),
                    QuestionType = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Trắc nghiệm")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EssayScore = table.Column<double>(type: "float", nullable: true),
